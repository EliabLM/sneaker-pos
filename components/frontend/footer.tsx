...
export default function Footer() {
  const navItems = [
    ...
    { label: 'Demo', href: '/#' },
    { label: 'Soporte', href: '/#' },
    // { label: 'Soporte', href: 'https://wa.me/message/5USU26346OWRF1' },
  ];

  const serviceItems = [
    { label: 'Sistema de Inventarios', href: '/' },
    { label: 'Implementación Personalizada', href: '/#' },
    { label: 'Migración de Datos', href: '/#' },
    { label: 'Capacitación de Personal', href: '/#' },
    { label: 'Integración con ERPs', href: '/#' },
    { label: 'Soporte Premium', href: '/#' },
  ];
        ...
        <div className='max-w-7xl mx-auto mb-16 flex flex-col md:flex-row justify-between items-start md:items-center'>
          <div className='mb-8 md:mb-0'>
            <h2 className='text-2xl md:text-3xl font-semibold mb-4 bg-gradient-to-r from-emerald-400 to-green-500 bg-clip-text text-transparent'>
              Optimiza tu inventario con SneakerPOS
            </h2>
            <p className='text-gray-400 max-w-xl text-base'>
              Simplifica la gestión de tu inventario con nuestra solución
              completa. Control total, reportes detallados y un sistema diseñado
              para crecer con tu negocio.
            </p>
          </div>
          <div className='flex gap-4 md:flex-row flex-col'>
            ...
            <ThemeButton href='#' title='Adquirir' />
          </div>
        </div>
